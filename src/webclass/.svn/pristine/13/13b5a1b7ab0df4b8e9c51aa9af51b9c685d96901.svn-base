...
<body>
	...
	<div id="video-remote" style="margin: 0 auto;">
		<div id="student-source" style="float: right; width: 200px; height: 200px; display: inline-block;"></div>
	</div>
	<div id="video-local" style="margin: 0 auto;">
		<div id="teacher-source" style="float: right; width: 200px; height: 200px; display: inline-block;"></div>
	</div>
</body>
...
<script src="/js/agora-test.js"></script>
</html>
