			...
			<div class="left">
				<div class="top">
					<div class="roominfo top-content">
						...
						<span class="room-time">00:00-00:50</span>&nbsp;|&nbsp;
						教室号∶<span class="room-id"></span>
					</div>
			...
			<div class="right">
				<div class="video">
					...
					<div class="video-tools">
						<span id="teacher-name" class="user-name">teacher</span>
...
<!-- 						<img class="user-video" src="/img/video/video-close.png" > -->
				...
				<div id="stu-v" class="video">
					<div id="student-source" class="video-src"></div>
					<div class="video-tools">
						<span id="student-name" class="user-name">student</span>
						<img class="user-prise" src="/img/video/prise-no.png" >
...
<!-- 						<a href="javascript:getOfflineMsg()">查看更多消息</a> -->
					</div>
...
<script src="/js/interact-init.js"></script>
</html>
